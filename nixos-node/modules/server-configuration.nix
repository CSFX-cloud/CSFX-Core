...
services:
  ...
  api-gateway:
    image: ghcr.io/csfx-cloud/csf-ce-api-gateway:0.2.2-alpha.400
  ...
  registry:
    image: ghcr.io/csfx-cloud/csf-ce-registry:0.2.2-alpha.400
  ...
  scheduler:
    image: ghcr.io/csfx-cloud/csf-ce-scheduler:0.2.2-alpha.400
  ...
  volume-manager:
    image: ghcr.io/csfx-cloud/csf-ce-volume-manager:0.2.2-alpha.400
  ...
  failover-controller:
    image: ghcr.io/csfx-cloud/csf-ce-failover-controller:0.2.2-alpha.400
  ...
  sdn-controller:
    image: ghcr.io/csfx-cloud/csf-ce-sdn-controller:0.2.2-alpha.400
