...
services:
  ...
  api-gateway:
    image: ghcr.io/csfx-cloud/csf-ce-api-gateway:${CSF_VERSION}
  ...
  registry:
    image: ghcr.io/csfx-cloud/csf-ce-registry:${CSF_VERSION}
  ...
  scheduler:
    image: ghcr.io/csfx-cloud/csf-ce-scheduler:${CSF_VERSION}
  ...
  volume-manager:
    image: ghcr.io/csfx-cloud/csf-ce-volume-manager:${CSF_VERSION}
  ...
  failover-controller:
    image: ghcr.io/csfx-cloud/csf-ce-failover-controller:${CSF_VERSION}
  ...
  sdn-controller:
    image: ghcr.io/csfx-cloud/csf-ce-sdn-controller:${CSF_VERSION}
